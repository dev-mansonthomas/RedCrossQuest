...
GRANT  UPDATE ON `¤MYSQL_DB¤`.tronc_queteur        TO `¤MYSQL_USER_WRITE¤`@'%' identified by '¤MYSQL_USER_WRITE_PASSWORD¤';
GRANT  UPDATE ON `¤MYSQL_DB¤`.queteur_registration TO `¤MYSQL_USER_WRITE¤`@'%';
