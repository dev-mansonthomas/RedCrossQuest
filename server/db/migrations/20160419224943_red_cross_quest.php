...
class RedCrossQuest extends AbstractMigration
{
    ...
    public function change()
    {
      ...
      $point_quete_table
        ...
        ->addColumn('nom'             , 'string' , array('limit' => 30))
        ->addColumn('latitude'        , 'decimal', array('precision' => 10, 'scale' => 6))
        ->addColumn('longitude'       , 'decimal', array('precision' => 10, 'scale' => 6))
        ->addColumn('address'         , 'string' , array('limit' => 70))
        ->addColumn('postal_code'     , 'string' , array('limit' => 15))
      ...
      $tronc_queteur_table
        ...
        ->addColumn('euro500'   , 'integer', array('comment' => 'nombre de billets de 500€'))
        ->addColumn('euro200'   , 'integer', array('comment' => 'nombre de billets de 200€'))
        ->addColumn('euro100'   , 'integer', array('comment' => 'nombre de billets de 100€'))
        ->addColumn('euro50'    , 'integer', array('comment' => 'nombre de billets de  50€'))
        ->addColumn('euro20'    , 'integer', array('comment' => 'nombre de billets de  20€'))
        ->addColumn('euro10'    , 'integer', array('comment' => 'nombre de billets de  10€'))
        ->addColumn('euro5'     , 'integer', array('comment' => 'nombre de billets de   5€'))
        ->addColumn('euro2'     , 'integer', array('comment' => 'nombre de pièces  de   2€'))
        ->addColumn('euro1'     , 'integer', array('comment' => 'nombre de pièces  de   1€'))
        ->addColumn('cents50'   , 'integer', array('comment' => 'nombre de pièces  de     50 cents'))
        ->addColumn('cents20'   , 'integer', array('comment' => 'nombre de pièces  de     20 cents'))
        ->addColumn('cents10'   , 'integer', array('comment' => 'nombre de pièces  de     10 cents'))
        ->addColumn('cents5'    , 'integer', array('comment' => 'nombre de pièces  de      5 cents'))
        ->addColumn('cents2'    , 'integer', array('comment' => 'nombre de pièces  de      2 cents'))
        ->addColumn('cent1'     , 'integer', array('comment' => 'nombre de pièces  de      1 cent '))

        ->addColumn('foreign_coins'    , 'integer', array('comment' => 'nombre de pièces  étrangères '))
        ->addColumn('foreign_banknote' , 'integer', array('comment' => 'nombre de billets étranger'   ))
